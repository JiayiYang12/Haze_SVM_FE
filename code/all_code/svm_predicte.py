...
for para_kernel in para_kernel_get:
    ...
    INPUT_PATH = './data_pro/Analysis/day_data/data_pro_aday.csv'   #用来训练的模型
    INPUT_PATH2 = './data_pro/Analysis/day_data/ceshi.csv'    #用来预测的因素
    OUTPUT_PATH = './data_pro/Analysis/day_data/test1_label_predict2.csv'
